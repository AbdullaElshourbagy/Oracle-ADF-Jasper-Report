...
public class JSFUtils
{
     ...
     * is defined under the application &lt;message-bundle&gt; referencedElement in
     * the faces config. Respects Locale
     * @param key string message label
     ...
     * from a defined error label and severity
     ...
     * @param componentId client id of the componenet
     * @param msg error message string
     */
    public static void addFacesErrorMessage(String componentId, String msg)
    {
        FacesContext ctx = getFacesContext();
        FacesMessage fm = new FacesMessage(FacesMessage.SEVERITY_ERROR, msg, msg);
        ctx.addMessage(componentId, fm);
        ctx.getCurrentInstance().renderResponse();
    }
    ...
    public static void convertStringToJboDate(String string) {
    }
}
